...
function Footer() {
  return (
    <section id='footer' className=' bg-gradient-to-t from-[#E1C9B7] to-[#F3E9E2] h-72 flex flex-col min-w-full' >
      ...
      {/* <article className='flex ml-12   absolute'>
      ...
      <article className='flex mx-auto items-end relative '>
        <img className='w-24 mb-2' src="./public/Logo_SoloMostacho.png" alt="Logo_Bigote" />
      </article> */}


      <article className='bg-[#383D42] h-full m-20'>
